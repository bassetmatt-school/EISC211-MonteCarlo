...
# font_dir = ['~/Documents/test/computer-modern']
    ...
    match style:
        case "code" :
            ...
            params['axes.prop_cycle'] = cycler('color', [\
                code.BLUE, code.RED, code.YELLOW, code.GREEN, code.GREY,\
                term.CYAN, term.PURPLE, term.CYAN2, term.WHITE,\
                default_colors.GREY])
        ...
        case "kde" :
            ...
            #lines colors :
            params['axes.prop_cycle'] = cycler('color', [\
                term.BLUE, term.RED, term.ORANGE, term.PURPLE2, term.RED2, \
                term.GREEN, term.BLUE2, term.WHITE2, \
                default_colors.BROWN, code.GREEN])
